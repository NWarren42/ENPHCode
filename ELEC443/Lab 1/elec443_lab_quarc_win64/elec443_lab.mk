###########################################################################
## Makefile generated for component 'elec443_lab'. 
## 
## Makefile     : elec443_lab.mk
## Generated on : Fri Oct 24 08:48:25 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\elec443_lab.rt-win64
...
COMPILER_COMMAND_FILE     = elec443_lab_comp.rsp
CMD_FILE                  = elec443_lab.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\elec443_lab.rt-win64
...
DEFINES_STANDARD = -DMODEL=elec443_lab -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\elec443_lab_quarc_win64\elec443_lab.c $(START_DIR)\elec443_lab_quarc_win64\elec443_lab_data.c $(START_DIR)\elec443_lab_quarc_win64\elec443_lab_main.c $(START_DIR)\elec443_lab_quarc_win64\rtGetInf.c $(START_DIR)\elec443_lab_quarc_win64\rtGetNaN.c $(START_DIR)\elec443_lab_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = elec443_lab.obj elec443_lab_data.obj elec443_lab_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\elec443_lab_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\elec443_lab_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
elec443_lab.obj : "$(START_DIR)\elec443_lab_quarc_win64\elec443_lab.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\elec443_lab_quarc_win64\elec443_lab.c"


elec443_lab_data.obj : "$(START_DIR)\elec443_lab_quarc_win64\elec443_lab_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\elec443_lab_quarc_win64\elec443_lab_data.c"


elec443_lab_main.obj : "$(START_DIR)\elec443_lab_quarc_win64\elec443_lab_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\elec443_lab_quarc_win64\elec443_lab_main.c"


rtGetInf.obj : "$(START_DIR)\elec443_lab_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\elec443_lab_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\elec443_lab_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\elec443_lab_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\elec443_lab_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\elec443_lab_quarc_win64\rt_nonfinite.c"
