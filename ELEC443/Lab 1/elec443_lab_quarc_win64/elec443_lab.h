...
#ifndef RTW_HEADER_elec443_lab_h_
#define RTW_HEADER_elec443_lab_h_
#ifndef elec443_lab_COMMON_INCLUDES_
#define elec443_lab_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* elec443_lab_COMMON_INCLUDES_ */

#include "elec443_lab_types.h"
...
#define elec443_lab_rtModel            RT_MODEL_elec443_lab_T

/* Block signals (default storage) */
typedef struct {
  real_T EncoderCalibrationradcount;
                                  /* '<S5>/Encoder Calibration  (rad//count)' */
  real_T EncoderHighPassFilter;        /* '<S5>/Encoder High-Pass Filter' */
  ...
  real_T UPMSaturationV;               /* '<S7>/UPM  Saturation (V)' */
} B_elec443_lab_T;
...
typedef struct {
  ...
  int32_T HILReadEncoderTimebase_Buffer;/* '<S5>/HIL Read Encoder Timebase' */
} DW_elec443_lab_T;

/* Continuous states (default storage) */
typedef struct {
  real_T EncoderHighPassFilter_CSTATE[2];/* '<S5>/Encoder High-Pass Filter' */
...
/* State disabled  */
typedef struct {
  boolean_T EncoderHighPassFilter_CSTATE[2];/* '<S5>/Encoder High-Pass Filter' */
...
#define rtB                            elec443_lab_B
#define BlockIO                        B_elec443_lab_T
#define rtX                            elec443_lab_X
#define ContinuousStates               X_elec443_lab_T
#define rtXdot                         elec443_lab_XDot
#define StateDerivatives               XDot_elec443_lab_T
#define tXdis                          elec443_lab_XDis
#define StateDisabled                  XDis_elec443_lab_T
#define rtP                            elec443_lab_P
#define Parameters                     P_elec443_lab_T
#define rtDWork                        elec443_lab_DW
#define D_Work                         DW_elec443_lab_T

/* Parameters (default storage) */
struct P_elec443_lab_T_ {
  ...
  real_T VMAX_DAC;                     /* Variable: VMAX_DAC
                                        ...
                                        */
  real_T VMAX_UPM;                     /* Variable: VMAX_UPM
                                        * Referenced by:
                                        *   '<S7>/UPM  Saturation (V)'
                                        *   '<S6>/UPM  Saturation (V)'
                                        */
...
extern P_elec443_lab_T elec443_lab_P;

/* Block signals (default storage) */
extern B_elec443_lab_T elec443_lab_B;

/* Continuous states (default storage) */
extern X_elec443_lab_T elec443_lab_X;

/* Block states (default storage) */
extern DW_elec443_lab_T elec443_lab_DW;

/* Model entry point functions */
extern void elec443_lab_initialize(void);
extern void elec443_lab_output(void);
extern void elec443_lab_update(void);
extern void elec443_lab_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern elec443_lab_rtModel *elec443_lab(void);
...
extern RT_MODEL_elec443_lab_T *const elec443_lab_M;
 ...
 *
 * '<Root>' : 'elec443_lab'
 * '<S1>'   : 'elec443_lab/Amplitude (V)'
 * '<S2>'   : 'elec443_lab/Offset (V)'
 * '<S3>'   : 'elec443_lab/SRV02 Experiment'
 * '<S4>'   : 'elec443_lab/SRV02 Simulation'
 * '<S5>'   : 'elec443_lab/SRV02 Experiment/SRV02-ET'
 * '<S6>'   : 'elec443_lab/SRV02 Experiment/SRV02-ET/Actuator Dynamics'
 * '<S7>'   : 'elec443_lab/SRV02 Simulation/Actuator Dynamics'
 */
#endif                                 /* RTW_HEADER_elec443_lab_h_ */
